...
ERROR_LINE_EXPECT = re.compile(r'// \[((java|c|swift) )?line (\d+)\] (Error.*)')
...
def swift_interpreter(name, tests):
  if name == 'Lox':
    dir = 'Products'
  else:
    dir = 'build/gen/' + name

  INTERPRETERS[name] = Interpreter(name, 'swift',
      ['Lox'], tests)


swift_interpreter('Lox', {
  'test': 'pass',
...
swift_interpreter('chap04_scanning', {
  # No interpreter yet.
  'test': 'skip',
...
swift_interpreter('chap06_parsing', {
...
swift_interpreter('chap07_evaluating', {
  # No real interpreter yet.
  'test': 'skip',
...
swift_interpreter('chap08_statements', {
  'test': 'pass',
...
swift_interpreter('chap09_control', {
  'test': 'pass',
...
swift_interpreter('chap10_functions', {
  'test': 'pass',
...
swift_interpreter('chap11_resolving', {
  'test': 'pass',
...
swift_interpreter('chap12_classes', {
  'test': 'pass',
...
swift_interpreter('chap13_inheritance', {
  'test': 'pass',
